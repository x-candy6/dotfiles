...
autocmd BufWritePre *.js,*.jsx,*.mjs,*.ts,*.tsx,*.css,*.less,*.scss,*.json,*.graphql,*.md,*.vue,*.htmldjango Prettier
...
let g:user_emmet_settings = webapi#json#decode(join(readfile(expand('/home/andy/.config/emmet-vim/snippets.json')), "\n"))


" vim-closetag configurations https://github.com/alvan/vim-closetag
...
"let g:floaterm_keymap_prev   = '<S-F5>'
...
"nnoremap <S-o> :call vimspector#StepOut()<CR>
"nnoremap <S-i> :call vimspector#StepInto()<CR>
"nnoremap <S-p> :call vimspector#StepOver()<CR>
