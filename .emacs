...
;disable eim in org-mode
(add-hook 'org-mode-hook (lambda () (electric-indent-mode -1)))
;(define-key org-mode-map (kbd "C-c C-t") 'electric-indent-mode) ; C-c C-t as a kbd
;(electric-indent-mode -1) ; globally ; the actual function
...
(use-package org-latex-impatient
  ...
  (setq org-latex-impatient-tex2svg-bin
        ...
        "/Users/andy/node_modules/tex2svg/"
        ))
...
;; mood journal
(tempo-define-template "mood"
           '(

             "Five things on your mind: " (p "Five-things: " five-thing) > n>
             "MOOD: " (p "MOOD:" mood) > n>
             "Efficiency Scale 1-10: " (p "efficiency: " efficiency) > n>
             "Last Entry: " 
             )
)
...
;;Stylesheets
;;blackmeadow
(tempo-define-template "css-blackmeadow"
           '(
"#+HTML_HEAD_EXTRA: <link rel='stylesheet' href='https://portalsf.surge.sh/static/stylesheets/blackmeadow.css' media='all'>" n

             )
)

;; LaTex Templates
(tempo-define-template "fancyhdr1"
           '(
"#+LATEX_HEADER: \\usepackage{fancyhdr}" n
"#+LATEX_HEADER: \\pagestyle{fancyplain}" n
"#+LATEX_HEADER: \\chead{AndrewC}" n
"#+LATEX_HEADER: \\lhead{}" n
"#+LATEX_HEADER: \\rhead{}" n
"#+LATEX_HEADER: \\cfoot{•  •}" n
"#+LATEX_HEADER: \\lfoot{}" n
"#+LATEX_HEADER: \\rfoot{}" n

             )
)
(tempo-define-template "geometry"
                       '(
                         "#+LATEX_HEADER: userpackage[margin=0.5]{geometry}"n
                         )
)
...
(tempo-define-template "cil"
           '(
              "#+SETUPFILE: http://portalsf.surge
              sh/static/org-themes/comfy_inline/comfy_inline.theme"
             )
)
